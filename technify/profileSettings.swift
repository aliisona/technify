...
public class Profile {
    ...
    init(usernameSet : String = "username", emailSet : String = "email", passwordSet : String = "password", focusSet : String = "genericFocus", postsSet : Int = 0, bioSet : String = "No bio", pfpSetString : String = "person.fill") {
